    ...
    <main className="relative flex-1 bg-mesh">
      ...
      <section className="pt-48 pb-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          >
            <div className="glass px-8 py-4 rounded-2xl flex items-center space-x-4 border-white/5">
              <Clock className="w-6 h-6 text-racing-red" />
              <div className="text-left">
                <p className="text-[10px] text-white/40 uppercase font-black tracking-widest">Lundi - Vendredi</p>
                <p className="text-white font-bold italic">10h00 — 19h00</p>
              </div>
            </div>
            <div className="glass px-8 py-4 rounded-2xl flex items-center space-x-4 border-white/5">
              <Clock className="w-6 h-6 text-racing-red" />
              <div className="text-left">
                <p className="text-[10px] text-white/40 uppercase font-black tracking-widest">Samedi</p>
                <p className="text-white font-bold italic">14h00 — 19h00</p>
              </div>
            </div>
          </motion.div>
        </div>
