          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div className="max-w-3xl">
              ...
              >
                ...
                <span className="font-black uppercase tracking-widest text-[10px] italic">Expertise SPEED MOTO PIECES</span>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="glass p-12 md:p-20 rounded-[4rem] border-white/5 relative overflow-hidden">
            ...
            {isPieces && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
                <div className="relative aspect-video rounded-[2.5rem] overflow-hidden glass border-white/5 group">
                  <Image src="/pices.jpg" alt="Pièces" fill className="object-contain p-8 group-hover:scale-110 transition-transform duration-700" />
                </div>
                <div>
            ...
            {isExport && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
                <div>
                  ...
                  <div className="space-y-6 text-white/50 text-lg leading-relaxed font-medium">
                    <p>Spécialiste de l'exportation de scooters et de pièces détachées, SPEED MOTO PIECES vous accompagne dans toutes vos démarches internationales. Nous gérons la logistique et les documents administratifs.</p>
                  </div>
                  <div className="flex flex-wrap gap-4 mt-12">
